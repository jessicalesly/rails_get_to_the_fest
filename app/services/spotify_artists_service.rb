class SpotifyArtistsService
  ...
  def list_artists
    ...
    lists_hash = {
      ...
      top_tracks: top_tracks_artists_array,
      saved_tracks: saved_tracks_artists_array,
      related: related_artists_array,
      total: top_artists_array + top_tracks_artists_array + saved_tracks_artists_array + related_artists_array
    }
    return lists_hash
  end
end
